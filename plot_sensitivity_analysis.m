...
title('Normalized terminal uncertainty', ...
    'FontWeight', 'bold', 'FontSize', 11)
legend({'Marker absent', 'Marker present'}, ...
...
xlabel(x_label)
ylabel('D_{travel} [m]')
title('Travel distance', 'FontWeight', 'bold', 'FontSize', 11)
legend({'Marker absent', 'Marker present'}, ...
    'Location', 'northwest', 'FontSize', 9)
format_sensitivity_axis(use_log_scale, x, x_tick_labels)
ylim([0, 3])
...
xlabel(x_label)
ylabel('D_{total}')
title('Total planning objective', 'FontWeight', 'bold', 'FontSize', 11)
legend({'Marker absent', 'Marker present'}, ...
    'Location', 'northwest', 'FontSize', 9)
format_sensitivity_axis(use_log_scale, x, x_tick_labels)
ylim([0, 3])
